...
class Application(models.Model):
    ...
    created_at = models.DateTimeField(default=timezone.now)
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='new')
    admin_comment = models.TextField(blank=True, null=True)  # для "Принято в работу"
    design_image = models.ImageField(upload_to='designs/', blank=True, null=True)  # для "Выполнено"
